	...
	'options-tab': {
        ...
        <table>
            ...
            <tr v-if="options.pauseclass">
				...
				<td><button class="optDark">{{ getGameName(102)[0] }}<br>内含暂停<br>不允许暂停</button></td>
            ...
            <tr v-if="options.pauseclass">
				...
				<td><button class="optDark">{{ getGameName(204)[0] }}<br>不依赖时钟<br>暂停无效</button></td>
            ...
            <tr v-if="options.pauseclass">
				...
				<td><button class="optDark">{{ getGameName(303)[0] }}<br>破坏游戏内容<br>不允许暂停</button></td>
				<td><button class="optDark">{{ getGameName(304)[0] }}<br>破坏游戏内容<br>不允许暂停</button></td>
            ...
            <tr v-if="options.pauseclass">
				...
				<td><button class="optDark">{{ getGameName(402)[0] }}<br>不依赖时钟<br>暂停无效</button></td>
				<td><button class="optDark">{{ getGameName(403)[0] }}<br>破坏游戏内容<br>不允许暂停</button></td>
				<td><button class="optDark">{{ getGameName(404)[0] }}<br>破坏游戏内容<br>不允许暂停</button></td>
            ...
            <tr v-if="options.pauseclass">
				...
				<td><button class="optDark">{{ getGameName(501)[0] }}<br>破坏游戏内容<br>不允许暂停</button></td>
