...
const FONT_DISPLAYS = ["默认", "Sligoil", "Angus", "Step mono", "Unica One", "Mathd", "FoxSize", "Misans 中文字体大请耐心等待", "等距更纱黑体 中文字体大请耐心等待", "荆南波波黑 中文字体大请耐心等待"];

const FONT_SETTINGS = ["", "Sligoil", "Angus", "Stepmono", "Unica", "Mathd", "fox", "Misans", "DJGSHT", "JNBBH"];
