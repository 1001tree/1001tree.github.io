addLayer("201", {
    ...
    upgrades: {
        ...
        61: {
            title: "暴涨III",
            description() {
                return `来点猛的, 暴涨II效果每秒乘以${format(player[this.layer].bzmul[3].times(player[this.layer].bzbase[3]))}<br>
    ...
    buyables: {
        ...
        22: {
            ...
            buy() {
                ...
                player[this.layer].rg = Math.max(-100, Math.min(100, player[this.layer].rg))
