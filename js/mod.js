...
let changelog = `
	<h1>须知:</h1><br><br>
	如需提出建议/反馈问题,可前往<a href="https://qm.qq.com/q/ApvcgvPhN8" target="_blank" rel="noopener noreferrer">游戏官方群</a>反馈<br>
	<br>
...
var doNotCallTheseFunctionsEveryTick = ['resetGame', 'getPrice', 'getEffect', 'executeBoost', 'getAutoGen',
	...
	"init304","amtboost","getadder","getmulty","getpowie","buyableReset","getFinalMult"
]
